...
class Advert(models.Model):
    ...
    # def validate_available_to(self):
    #     now = datetime.datetime.now()
    #     now = now.strftime("%Y-%m-%d")
    #     print(now, self.available_to)
    #     if self.available_to < now:
    #         raise ValidationError("Ensure that written available end date is greater than today ")
